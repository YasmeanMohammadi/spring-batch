...
public class PersonResourceIT {
    ...
    public void createPerson() throws Exception {
        ...
        assertThat(testPerson.getDate()).isEqualTo(DEFAULT_DATE);
    }
    ...
    @Test
    @Transactional
    public void getAllPeopleByDateIsEqualToSomething() throws Exception {
        // Initialize the database
        personRepository.saveAndFlush(person);

        // Get all the personList where date equals to DEFAULT_DATE
        defaultPersonShouldBeFound("date.equals=" + DEFAULT_DATE);

        // Get all the personList where date equals to UPDATED_DATE
        defaultPersonShouldNotBeFound("date.equals=" + UPDATED_DATE);
    }

    @Test
    @Transactional
    public void getAllPeopleByDateIsNotEqualToSomething() throws Exception {
        // Initialize the database
        personRepository.saveAndFlush(person);

        // Get all the personList where date not equals to DEFAULT_DATE
        defaultPersonShouldNotBeFound("date.notEquals=" + DEFAULT_DATE);

        // Get all the personList where date not equals to UPDATED_DATE
        defaultPersonShouldBeFound("date.notEquals=" + UPDATED_DATE);
    }

    @Test
    @Transactional
    public void getAllPeopleByDateIsInShouldWork() throws Exception {
        // Initialize the database
        personRepository.saveAndFlush(person);

        // Get all the personList where date in DEFAULT_DATE or UPDATED_DATE
        defaultPersonShouldBeFound("date.in=" + DEFAULT_DATE + "," + UPDATED_DATE);

        // Get all the personList where date equals to UPDATED_DATE
        defaultPersonShouldNotBeFound("date.in=" + UPDATED_DATE);
    }

    @Test
    @Transactional
    public void getAllPeopleByDateIsNullOrNotNull() throws Exception {
        // Initialize the database
        personRepository.saveAndFlush(person);

        // Get all the personList where date is not null
        defaultPersonShouldBeFound("date.specified=true");

        // Get all the personList where date is null
        defaultPersonShouldNotBeFound("date.specified=false");
    }
    /**
    ...
    public void updatePerson() throws Exception {
        ...
        assertThat(testPerson.getDate()).isEqualTo(UPDATED_DATE);
    }
